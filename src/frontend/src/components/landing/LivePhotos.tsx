...
export default function LivePhotos() {
  ...
  const livePhotos = [
    ...
    },
    {
      ...
      label: t.livePhotos.sofaBeforeAfter,
    },
    {
      ...
      <div className="container px-4 md:px-6">
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="mb-3 text-balance text-2xl font-bold tracking-tight text-primary sm:text-3xl md:text-4xl lg:text-5xl">
            {t.livePhotos.heading}
          </h2>
          <p className="mb-8 text-balance text-sm text-muted-foreground md:text-base lg:text-lg">
            {t.livePhotos.description}
          </p>
        </div>
