...
export default function WhyChooseUs() {
  ...
  const STATS = [
    ...
    { value: "250+", label: wcu.statReviews ?? "Google Reviews" },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {FEATURE_KEYS.map((feature) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-bold text-foreground font-body mb-1">
                  {title}
                </h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
          {STATS.map((stat) => (
            ...
            >
              <div className="text-3xl font-bold text-primary font-body mb-1">
                {stat.value}
              </div>
