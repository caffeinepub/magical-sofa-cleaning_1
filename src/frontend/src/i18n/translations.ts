...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    serviceCoverage: {
      ...
      caption: 'Professional doorstep cleaning services available across all major areas',
    },
    services: {
  ...
  hi: {
    ...
    serviceCoverage: {
      ...
      caption: 'सभी प्रमुख क्षेत्रों में प्रोफेशनल डोरस्टेप क्लीनिंग सेवाएं उपलब्ध',
    },
    services: {
    ...
    whyChooseUs: {
      ...
      ecoFriendlyTitle: 'इको-फ्रेंडली केमिकल्स',
      ecoFriendlyDescription: 'हम केवल पर्यावरण के अनुकूल, गैर-विषैले क्लीनिंग समाधानों का उपयोग करते हैं जो आपके फर्नीचर पर कोमल और आपके परिवार और पालतू जानवरों के लिए सुरक्षित हैं।',
      ...
      goldStandardDescription: 'प्रीमियम, उद्योग-अग्रणी उपकरण और मशीनरी हर बार अपेक्षाओं से अधिक प्रोफेशनल-ग्रेड क्लीनिंग प्रदान करती है।',
      certifiedExpertsTitle: 'प्रमाणित विशेषज्ञ',
      certifiedExpertsDescription: 'हमारे प्रशिक्षित और प्रमाणित पेशेवर हर क्लीनिंग कार्य में वर्षों का अनुभव और विशेषज्ञता लाते हैं, गुणवत्ता सेवा सुनिश्चित करते हैं।',
    },
    appointment: {
    ...
    areas: {
      ...
      description: 'अहमदाबाद और गांधीनगर के सभी प्रमुख क्षेत्रों में प्रोफेशनल सोफा क्लीनिंग सेवाएं, कार्पेट, मैट्रेस, चेयर क्लीनिंग और एसी सेवाएं',
      ahmedabad: 'अहमदाबाद',
    ...
    reviews: {
      ...
      review2: '"अहमदाबाद में सबसे अच्छी कार्पेट क्लीनिंग सेवा! उन्होंने सभी कठिन दागों को हटा दिया और कार्पेट जल्दी सूख गया। अत्यधिक अनुशंसित!"',
  ...
  gu: {
    ...
    hero: {
      ...
      description: 'અમે માત્ર ₹90/ફૂટ પર નિષ્ણાત ક્લીનિંગ સેવાઓ પ્રદાન કરીએ છીએ, તે જ દિવસે ઉપલબ્ધતા સાથે। 210+ ગ્રાહકો દ્વારા 5-સ્ટાર સમીક્ષાઓ સાથે વિશ્વસનીય, અમે નિકોલ, નરોડા, સેટેલાઇટ અને એસજી હાઇવે સહિત અમદાવાદ અને ગાંધીનગરના તમામ વિસ્તારોમાં સેવા આપીએ છીએ।',
    ...
    serviceCoverage: {
      ...
      caption: 'તમામ મુખ્ય વિસ્તારોમાં પ્રોફેશનલ ડોરસ્ટેપ ક્લીનિંગ સેવાઓ ઉપલબ્ધ',
    },
    services: {
      ...
      chairDescription: 'અમદાવાદમાં ઓફિસ ચેર, ડાઇનિંગ ચેર અને તમામ સીટિંગ ફર્નિચર માટે નિષ્ણાત ક્લીનિંગ। ડીપ ક્લીનિંગ ડાઘ અને ગંધને અસરકારક રીતે દૂર કરે છે।',
      mattressTitle: 'અમદાવાદમાં મેટ્રેસ ક્લીનિંગ',
      mattressDescription: 'અમારી પ્રોફેશનલ મેટ્રેસ ડીપ ક્લીનિંગ અને સેનિટાઇઝેશન સેવા સાથે તંદુરસ્ત ઊંઘનો અનુભવ કરો। અમે તમામ મેટ્રેસ પ્રકારો માટે અદ્યતન સાધનો અને ઇકો-ફ્રેન્ડલી સોલ્યુશન્સનો ઉપયોગ કરીને ધૂળના જીવાણુઓ, એલર્જી, બેક્ટેરિયા અને જીદ્દી ડાઘને દૂર કરીએ છીએ।',
    ...
    whyChooseUs: {
      ...
      description: 'અત્યાધુનિક ટેકનોલોજી અને ઇકો-ફ્રેન્ડલી પ્રથાઓ દ્વારા સમર્થિત અમારી પ્રીમિયમ ક્લીનિંગ સેવાઓ સાથે તફાવતનો અનુભવ કરો',
      ecoFriendlyTitle: 'ઇકો-ફ્રેન્ડલી કેમિકલ્સ',
      ecoFriendlyDescription: 'અમે ફક્ત પર્યાવરણને અનુકૂળ, બિન-ઝેરી ક્લીનિંગ સોલ્યુશન્સનો ઉપયોગ કરીએ છીએ જે તમારા ફર્નિચર પર નરમ અને તમારા પરિવાર અને પાલતુ પ્રાણીઓ માટે સુરક્ષિત છે।',
      ...
      goldStandardDescription: 'પ્રીમિયમ, ઉદ્યોગ-અગ્રણી સાધનો અને મશીનરી દરેક વખતે અપેક્ષાઓ કરતાં વધુ પ્રોફેશનલ-ગ્રેડ ક્લીનિંગ પ્રદાન કરે છે।',
      certifiedExpertsTitle: 'પ્રમાણિત નિષ્ણાતો',
      certifiedExpertsDescription: 'અમારા પ્રશિક્ષિત અને પ્રમાણિત વ્યાવસાયિકો દરેક ક્લીનિંગ કાર્યમાં વર્ષોનો અનુભવ અને નિપુણતા લાવે છે, ગુણવત્તા સેવાની ખાતરી કરે છે।',
    },
    appointment: {
    ...
    livePhotos: {
      ...
      description: 'અમદાવાદમાં અમારી પ્રોફેશનલ ક્લીનિંગ સેવાઓના વાસ્તવિક ફોટા',
      sofaBeforeAfter: 'સોફા ક્લીનિંગ (પહેલાં / પછી)',
      officeChairCleaning: 'ઓફિસ ચેર ક્લીનિંગ',
    },
    areas: {
      heading: 'અમદાવાદમાં અમે જ્યાં સેવા આપીએ છીએ',
      description: 'અમદાવાદ અને ગાંધીનગરના તમામ મુખ્ય વિસ્તારોમાં પ્રોફેશનલ સોફા ક્લીનિંગ સેવાઓ, કાર્પેટ, મેટ્રેસ, ચેર ક્લીનિંગ અને એસી સેવાઓ',
      ahmedabad: 'અમદાવાદ',
    ...
    reviews: {
      ...
      description: 'અમદાવાદ અને ગાંધીનગરમાં સેંકડો સંતુષ્ટ ગ્રાહકો દ્વારા વિશ્વસનીય',
      ...
      review2: '"અમદાવાદમાં શ્રેષ્ઠ કાર્પેટ ક્લીનિંગ સેવા! તેઓએ તમામ કઠિન ડાઘ દૂર કર્યા અને કાર્પેટ ઝડપથી સુકાઈ ગયું। અત્યંત ભલામણ કરેલ!"',
    ...
    footer: {
      ...
      companyDescription: 'અમદાવાદ અને ગાંધીનગરમાં પ્રોફેશનલ ક્લીનિંગ સેવાઓ। નિષ્ણાત સોફા, કાર્પેટ, મેટ્રેસ, ચેર ક્લીનિંગ અને એસી વોટર જેટ સેવાઓ।',
