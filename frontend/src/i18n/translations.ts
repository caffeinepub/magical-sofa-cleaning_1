...
export const translations: Record<Locale, Translations> = {
  en: {
    ...
    hero: {
      ...
      description: 'Premium sofa cleaning services across Ahmedabad including Nikol, Naroda, Bapunagar, and surrounding areas. Professional deep cleaning for homes and offices with guaranteed results.',
      chipHygienic: 'Hygienic & Safe',
      chipQuickDry: 'Quick Dry (~2hrs)',
      chipThorough: 'Thorough Clean',
      chipReviews: '230+ Reviews',
      ctaCall: 'Call Now',
      ctaWhatsApp: 'WhatsApp Us',
      sameDayService: 'Same Day Service',
      whyChooseMagicalHeading: 'Why Choose Magical Service?',
      whyChooseMagicalPoint1: 'German machines technology for deep cleaning with Quick Dry (~2 hours)',
      whyChooseMagicalPoint2: 'Eco-friendly, non-toxic chemicals safe for children & pets',
      whyChooseMagicalPoint3: 'Certified experts serving Nikol, Naroda, Bapunagar & all Ahmedabad areas',
    ...
    serviceCoverage: {
      ...
      caption: 'Serving Nana Chiloda, Odhav, and 100+ areas across Ahmedabad and Gandhinagar with premium sofa cleaning services.',
    },
    coverage: {
    ...
    services: {
      ...
      description: 'Expert cleaning services available across Kathwada, Krishna Nagar, Kuber Nagar, and all major areas in Ahmedabad. Premium quality guaranteed.',
      popular: 'Popular',
      startingAt: 'Starting at',
      sameDayAvailable: 'Same day available',
      availableServices: 'Available Services',
      sofaTitle: 'Sofa Cleaning',
      sofaDescription: 'Professional deep cleaning for all sofa types. Removes stains, odors, and allergens using German machine technology.',
      carpetTitle: 'Carpet Cleaning',
      carpetDescription: 'Expert carpet cleaning to restore original beauty. Removes deep-set dirt, stains, and odors effectively.',
      chairTitle: 'Chair Cleaning',
      chairDescription: 'Professional office and dining chair cleaning. Safe for all fabric types with quick dry technology.',
      mattressTitle: 'Mattress Cleaning',
      mattressDescription: 'Deep mattress sanitization to eliminate dust mites, bacteria, and allergens for healthier sleep.',
      acTitle: 'AC Water Jet Service',
      acDescription: 'Professional AC deep cleaning with water jet technology. Improves air quality and AC efficiency.',
      acWaterJet: 'Water Jet Technology',
      badge: 'Our Services',
      title: 'Professional Cleaning Services',
      subtitle: 'Expert upholstery and deep cleaning services for your home and office in Ahmedabad',
      bookNow: 'Book Now',
    ...
    calculator: {
      ...
      areaLabel: 'Your Area',
      perUnit: 'per unit',
      mattressNote: 'Mattress Cleaning – ₹600 per mattress (deep steam cleaning)',
    },
    whyChooseUs: {
      heading: 'Why Choose Magical Service?',
      description: 'We combine expertise, eco-friendly products, and exceptional service to deliver outstanding results every time.',
      ecoFriendlyTitle: 'Eco-Friendly Products',
      ecoFriendlyDescription: 'We use only non-toxic, biodegradable cleaning products that are safe for children, pets, and the environment.',
      germanMachinesTitle: 'German Machine Technology',
      germanMachinesDescription: 'Advanced German cleaning machines ensure deep cleaning with Quick Dry technology (~2 hours drying time).',
      goldStandardTitle: 'Gold Standard Quality',
      goldStandardDescription: 'Our gold standard cleaning process ensures every fiber is cleaned, sanitized, and refreshed to perfection.',
      certifiedExpertsTitle: 'Certified Experts',
      certifiedExpertsDescription: 'Our team is trained and certified in advanced upholstery cleaning techniques for all fabric types.',
      badge: 'Why Choose Us',
      title: 'The Magical Service Difference',
      subtitle: 'We combine expertise, eco-friendly products, and exceptional service to deliver outstanding results every time.',
      certifiedTitle: 'Certified Professionals',
      certifiedDesc: 'Our team is trained and certified in advanced upholstery cleaning techniques for all fabric types.',
      sameDayTitle: 'Same Day Service',
      sameDayDesc: 'Need urgent cleaning? We offer same-day service across Ahmedabad, subject to availability.',
      ecoTitle: 'Eco-Friendly Products',
      ecoDesc: 'We use only non-toxic, biodegradable cleaning products that are safe for children, pets, and the environment.',
      experiencedTitle: '5+ Years Experience',
      experiencedDesc: 'With over 5 years of experience, we have cleaned thousands of sofas, mattresses, and carpets across Ahmedabad.',
      satisfactionTitle: '100% Satisfaction',
      satisfactionDesc: 'We guarantee your satisfaction. If you are not happy with our service, we will re-clean at no extra charge.',
      coverageTitle: 'Wide Coverage',
      coverageDesc: 'We serve all major areas of Ahmedabad and Gandhinagar including Nikol, Naroda, Bapunagar, Odhav, and more.',
    ...
    appointment: {
      ...
      description: 'Schedule your cleaning service today. Same-day appointments available.',
      cardTitle: 'Book Cleaning Service',
      cardDescription: "Fill in your details and we'll confirm via WhatsApp within 30 minutes.",
      nameLabel: 'Your Name',
      ...
      subtitle: "Fill in the details below and we'll confirm your appointment via WhatsApp",
      name: 'Your Name',
      phone: 'Phone Number',
      ...
      disclaimer: "We'll confirm your appointment within 30 minutes via WhatsApp",
    },
    serviceOptions: {
    ...
    livePhotos: {
      ...
      subtitle: 'Real photos from our cleaning jobs across Ahmedabad. See the quality of our work firsthand.',
    },
    areasServed: {
      heading: 'Areas We Serve in Ahmedabad',
      description: 'Comprehensive sofa cleaning coverage across Nikol, Naroda, Bapunagar, Hanspura, Odhav, and 100+ localities in Ahmedabad and Gandhinagar.',
      badge: 'Service Coverage',
      title: 'Areas We Serve in Ahmedabad',
      subtitle: 'We provide professional upholstery cleaning services across Ahmedabad and Gandhinagar. From Nikol and Naroda in the east to Bopal and Satellite in the west — we cover it all.',
    ...
    faq: {
      ...
      a1: 'We provide sofa cleaning services across all areas of Ahmedabad including Nikol, Naroda, Bapunagar, Hanspura, Odhav, Kathwada, Nana Chiloda, Krishna Nagar, Kuber Nagar, Vastral, Satellite, SG Highway, Maninagar, Vejalpur, Bopal, Chandkheda, and all of Gandhinagar.',
      ...
      a6: 'We clean all types of sofas including fabric, leather, velvet, microfiber, and suede. Our certified technicians are trained for all fabric types.',
    ...
    footer: {
      ...
      companyDescription: 'Premium sofa and upholstery cleaning services across Ahmedabad and Gandhinagar.',
      ...
      tagline: "Ahmedabad's trusted sofa & upholstery cleaning experts",
      contact: 'Contact',
  ...
  hi: {
    ...
    hero: {
      ...
      description: 'अहमदाबाद में निकोल, नरोडा, बापूनगर और आसपास के क्षेत्रों में प्रीमियम सोफा क्लीनिंग सेवाएं।',
      chipHygienic: 'स्वच्छ और सुरक्षित',
      chipQuickDry: 'जल्दी सूखे (~2 घंटे)',
      chipThorough: 'पूरी तरह साफ',
      chipReviews: '230+ समीक्षाएं',
      ...
      whyChooseMagicalPoint2: 'बच्चों और पालतू जानवरों के लिए सुरक्षित इको-फ्रेंडली रसायन',
      whyChooseMagicalPoint3: 'निकोल, नरोडा, बापूनगर और सभी अहमदाबाद क्षेत्रों में प्रमाणित विशेषज्ञ',
    ...
    serviceCoverage: {
      ...
      caption: 'नाना चिलोडा, ओढव और अहमदाबाद-गांधीनगर के 100+ क्षेत्रों में प्रीमियम सोफा क्लीनिंग।',
    },
    coverage: {
    ...
    services: {
      ...
      description: 'कठवाड़ा, कृष्णा नगर, कुबेर नगर और अहमदाबाद के सभी प्रमुख क्षेत्रों में विशेषज्ञ क्लीनिंग सेवाएं।',
      popular: 'लोकप्रिय',
      startingAt: 'शुरुआत',
      sameDayAvailable: 'उसी दिन उपलब्ध',
      availableServices: 'उपलब्ध सेवाएं',
      sofaTitle: 'सोफा क्लीनिंग',
      sofaDescription: 'सभी प्रकार के सोफे के लिए प्रोफेशनल डीप क्लीनिंग। जर्मन मशीन तकनीक से दाग, गंध और एलर्जेन हटाएं।',
      carpetTitle: 'कार्पेट क्लीनिंग',
      carpetDescription: 'मूल सुंदरता बहाल करने के लिए विशेषज्ञ कार्पेट क्लीनिंग। गहरी गंदगी, दाग और गंध प्रभावी ढंग से हटाएं।',
      chairTitle: 'कुर्सी क्लीनिंग',
      chairDescription: 'प्रोफेशनल ऑफिस और डाइनिंग चेयर क्लीनिंग। सभी फैब्रिक प्रकारों के लिए सुरक्षित।',
      mattressTitle: 'मैट्रेस क्लीनिंग',
      mattressDescription: 'स्वस्थ नींद के लिए धूल के कण, बैक्टीरिया और एलर्जेन को खत्म करने के लिए डीप मैट्रेस सैनिटाइजेशन।',
      acTitle: 'AC वाटर जेट सर्विस',
      acDescription: 'वाटर जेट तकनीक से प्रोफेशनल AC डीप क्लीनिंग। वायु गुणवत्ता और AC दक्षता में सुधार।',
      acWaterJet: 'वाटर जेट तकनीक',
      badge: 'हमारी सेवाएं',
      title: 'प्रोफेशनल क्लीनिंग सेवाएं',
      subtitle: 'अहमदाबाद में आपके घर और ऑफिस के लिए विशेषज्ञ अपहोल्स्ट्री और डीप क्लीनिंग सेवाएं',
    ...
    whyChooseUs: {
      ...
      description: 'हम हर बार उत्कृष्ट परिणाम देने के लिए विशेषज्ञता, इको-फ्रेंडली उत्पाद और असाधारण सेवा को जोड़ते हैं।',
      ecoFriendlyTitle: 'इको-फ्रेंडली उत्पाद',
      ecoFriendlyDescription: 'हम केवल गैर-विषाक्त, बायोडिग्रेडेबल क्लीनिंग उत्पादों का उपयोग करते हैं जो बच्चों, पालतू जानवरों और पर्यावरण के लिए सुरक्षित हैं।',
      germanMachinesTitle: 'जर्मन मशीन तकनीक',
      germanMachinesDescription: 'उन्नत जर्मन क्लीनिंग मशीनें Quick Dry तकनीक (~2 घंटे सुखाने का समय) के साथ डीप क्लीनिंग सुनिश्चित करती हैं।',
      goldStandardTitle: 'गोल्ड स्टैंडर्ड गुणवत्ता',
      goldStandardDescription: 'हमारी गोल्ड स्टैंडर्ड क्लीनिंग प्रक्रिया सुनिश्चित करती है कि हर फाइबर को परफेक्ट तरीके से साफ, सैनिटाइज और ताजा किया जाए।',
      certifiedExpertsTitle: 'प्रमाणित विशेषज्ञ',
      certifiedExpertsDescription: 'हमारी टीम सभी फैब्रिक प्रकारों के लिए उन्नत अपहोल्स्ट्री क्लीनिंग तकनीकों में प्रशिक्षित और प्रमाणित है।',
      badge: 'हमें क्यों चुनें',
      title: 'Magical Service का अंतर',
      subtitle: 'हम हर बार उत्कृष्ट परिणाम देने के लिए विशेषज्ञता, इको-फ्रेंडली उत्पाद और असाधारण सेवा को जोड़ते हैं।',
      certifiedTitle: 'प्रमाणित पेशेवर',
      certifiedDesc: 'हमारी टीम सभी फैब्रिक प्रकारों के लिए उन्नत अपहोल्स्ट्री क्लीनिंग तकनीकों में प्रशिक्षित और प्रमाणित है।',
      sameDayTitle: 'उसी दिन सेवा',
      sameDayDesc: 'तत्काल क्लीनिंग चाहिए? हम उपलब्धता के अधीन अहमदाबाद में उसी दिन सेवा प्रदान करते हैं।',
      ...
      experiencedDesc: '5 साल से अधिक के अनुभव के साथ, हमने अहमदाबाद में हजारों सोफे, मैट्रेस और कार्पेट साफ किए हैं।',
      satisfactionTitle: '100% संतुष्टि',
      satisfactionDesc: 'हम आपकी संतुष्टि की गारंटी देते हैं। यदि आप हमारी सेवा से खुश नहीं हैं, तो हम बिना किसी अतिरिक्त शुल्क के दोबारा साफ करेंगे।',
      coverageTitle: 'व्यापक कवरेज',
      coverageDesc: 'हम निकोल, नरोडा, बापूनगर, ओढव और अधिक सहित अहमदाबाद और गांधीनगर के सभी प्रमुख क्षेत्रों में सेवा देते हैं।',
    ...
    appointment: {
      ...
      cardDescription: 'अपना विवरण भरें और हम 30 मिनट के भीतर WhatsApp पर पुष्टि करेंगे।',
      nameLabel: 'आपका नाम',
    ...
    livePhotos: {
      ...
      badge: 'लाइव फोटो',
      title: 'हमारा काम',
      subtitle: 'अहमदाबाद में हमारी क्लीनिंग जॉब्स की वास्तविक तस्वीरें। हमारे काम की गुणवत्ता खुद देखें।',
    },
    areasServed: {
      heading: 'अहमदाबाद में हम जहां सेवा देते हैं',
      description: 'निकोल, नरोडा, बापूनगर, हंसपुरा, ओढव और अहमदाबाद-गांधीनगर के 100+ इलाकों में व्यापक सोफा क्लीनिंग कवरेज।',
      badge: 'सेवा कवरेज',
      title: 'अहमदाबाद में हम जहां सेवा देते हैं',
      subtitle: 'हम अहमदाबाद और गांधीनगर में प्रोफेशनल अपहोल्स्ट्री क्लीनिंग सेवाएं प्रदान करते हैं।',
    ...
    footer: {
      companyName: 'Magical Service',
      companyDescription: 'अहमदाबाद और गांधीनगर में प्रीमियम सोफा और अपहोल्स्ट्री क्लीनिंग सेवाएं।',
  ...
  gu: {
    ...
    hero: {
      ...
      description: 'અમદાવાદમાં નિકોલ, નરોડા, બાપુનગર અને આસપાસના વિસ્તારોમાં પ્રીમિયમ સોફા ક્લીનિંગ સેવાઓ.',
      chipHygienic: 'સ્વચ્છ અને સુરક્ષિત',
      chipQuickDry: 'ઝડપી સૂકવણી (~2 કલાક)',
      chipThorough: 'સંપૂર્ણ સ્વચ્છ',
      chipReviews: '230+ સમીક્ષાઓ',
      ctaCall: 'હવે કૉલ કરો',
      ctaWhatsApp: 'WhatsApp કરો',
      sameDayService: 'તે જ દિવસે સેવા',
      whyChooseMagicalHeading: 'Magical Service કેમ પસંદ કરો?',
      whyChooseMagicalPoint1: 'જર્મન મશીન ટેક્નોલોજી ડીપ ક્લીનિંગ સાથે Quick Dry (~2 કલાક)',
      whyChooseMagicalPoint2: 'બાળકો અને પાળતુ પ્રાણીઓ માટે સુરક્ષિત ઇકો-ફ્રેન્ડલી રસાયણો',
      whyChooseMagicalPoint3: 'નિકોલ, નરોડા, બાપુનગર અને તમામ અમદાવાદ વિસ્તારોમાં પ્રમાણિત નિષ્ણાતો',
    ...
    serviceCoverage: {
      ...
      caption: 'નાના ચિલોડા, ઓઢવ અને અમદાવાદ-ગાંધીનગરના 100+ વિસ્તારોમાં પ્રીમિયમ સોફા ક્લીનિંગ.',
    },
    coverage: {
    ...
    services: {
      ...
      description: 'કઠવાડા, કૃષ્ણા નગર, કુબેર નગર અને અમદાવાદના તમામ મુખ્ય વિસ્તારોમાં નિષ્ણાત ક્લીનિંગ સેવાઓ.',
      popular: 'લોકપ્રિય',
      startingAt: 'શરૂઆત',
      sameDayAvailable: 'તે જ દિવસે ઉપલબ્ધ',
      availableServices: 'ઉપલબ્ધ સેવાઓ',
      sofaTitle: 'સોફા ક્લીનિંગ',
      sofaDescription: 'તમામ પ્રકારના સોફા માટે પ્રોફેશનલ ડીપ ક્લીનિંગ. જર્મન મશીન ટેક્નોલોજી વડે ડાઘ, ગંધ અને એલર્જન દૂર કરો.',
      ...
      chairDescription: 'પ્રોફેશનલ ઓફિસ અને ડાઇનિંગ ચેર ક્લીનિંગ. ઝડપી સૂકવણી ટેક્નોલોજી સાથે.',
      mattressTitle: 'મેટ્રેસ ક્લીનિંગ',
      mattressDescription: 'સ્વસ્થ ઊંઘ માટે ધૂળના જીવાત, બેક્ટેરિયા અને એલર્જન દૂર કરવા ડીપ મેટ્રેસ સેનિટાઇઝેશન.',
      ...
      subtitle: 'અમદાવાદમાં તમારા ઘર અને ઓફિસ માટે નિષ્ણાત અપહોલ્સ્ટ્રી અને ડીપ ક્લીનિંગ સેવાઓ',
      bookNow: 'હવે બુક કરો',
    ...
    whyChooseUs: {
      ...
      description: 'અમે દર વખતે ઉત્કૃષ્ટ પરિણામ આપવા માટે નિષ્ણાત, ઇકો-ફ્રેન્ડલી ઉત્પાદનો અને અસાધારણ સેવાને જોડીએ છીએ.',
      ecoFriendlyTitle: 'ઇકો-ફ્રેન્ડલી ઉત્પાદનો',
      ecoFriendlyDescription: 'અમે ફક્ત બિન-ઝેરી, બાયોડિગ્રેડેબલ ક્લીનિંગ ઉત્પાદનોનો ઉપયોગ કરીએ છીએ જે બાળકો, પાળતુ પ્રાણીઓ અને પર્યાવરણ માટે સુરક્ષિત છે.',
      germanMachinesTitle: 'જર્મન મશીન ટેક્નોલોજી',
      germanMachinesDescription: 'અદ્યતન જર્મન ક્લીનિંગ મશીનો Quick Dry ટેક્નોલોજી (~2 કલાક સૂકવવાનો સમય) સાથે ડીપ ક્લીનિંગ સુનિશ્ચિત કરે છે.',
      goldStandardTitle: 'ગોલ્ડ સ્ટાન્ડર્ડ ગુણવત્તા',
      goldStandardDescription: 'અમારી ગોલ્ડ સ્ટાન્ડર્ડ ક્લીનિંગ પ્રક્રિયા સુનિશ્ચિત કરે છે કે દરેક ફાઇબર સ્વચ્છ, સેનિટાઇઝ અને તાજો થાય.',
      certifiedExpertsTitle: 'પ્રમાણિત નિષ્ણાતો',
      certifiedExpertsDescription: 'અમારી ટીમ તમામ ફેબ્રિક પ્રકારો માટે અદ્યતન અપહોલ્સ્ટ્રી ક્લીનિંગ તકનીકોમાં પ્રશિક્ષિત અને પ્રમાણિત છે.',
      badge: 'અમને કેમ પસંદ કરો',
      title: 'Magical Service નો તફાવત',
      subtitle: 'અમે દર વખતે ઉત્કૃષ્ટ પરિણામ આપવા માટે નિષ્ણાત, ઇકો-ફ્રેન્ડલી ઉત્પાદનો અને અસાધારણ સેવાને જોડીએ છીએ.',
      certifiedTitle: 'પ્રમાણિત વ્યાવસાયિકો',
      certifiedDesc: 'અમારી ટીમ તમામ ફેબ્રિક પ્રકારો માટે અદ્યતન અપહોલ્સ્ટ્રી ક્લીનિંગ તકનીકોમાં પ્રશિક્ષિત અને પ્રમાણિત છે.',
      sameDayTitle: 'તે જ દિવસે સેવા',
      sameDayDesc: 'તાત્કાલિક ક્લીનિંગ જોઈએ? અમે ઉપલબ્ધતાને આધીન અમદાવાદમાં તે જ દિવસે સેવા ઓફર કરીએ છીએ.',
      ...
      experiencedDesc: '5 વર્ષથી વધુ અનુભવ સાથે, અમે અમદાવાદમાં હજારો સોફા, મેટ્રેસ અને કાર્પેટ સ્વચ્છ કર્યા છે.',
      satisfactionTitle: '100% સંતોષ',
      satisfactionDesc: 'અમે તમારા સંતોષની ગેરંટી આપીએ છીએ. જો તમે અમારી સેવાથી ખુશ ન હો, તો અમે કોઈ વધારાના ચાર્જ વિના ફરીથી સ્વચ્છ કરીશું.',
      coverageTitle: 'વ્યાપક કવરેજ',
      coverageDesc: 'અમે નિકોલ, નરોડા, બાપુનગર, ઓઢવ અને વધુ સહિત અમદાવાદ અને ગાંધીનગરના તમામ મુખ્ય વિસ્તારોમાં સેવા આપીએ છીએ.',
    ...
    appointment: {
      ...
      cardDescription: 'તમારી વિગતો ભરો અને અમે 30 મિનિટ અંદર WhatsApp પર પુષ્ટિ કરીશું.',
    ...
    livePhotos: {
      ...
      badge: 'લાઇવ ફોટો',
      title: 'અમારું કામ',
      subtitle: 'અમદાવાદમાં અમારી ક્લીનિંગ જૉબ્સની વાસ્તવિક તસ્વીરો. અમારા કામની ગુણવત્તા જાતે જુઓ.',
    },
    areasServed: {
      heading: 'અમદાવાદમાં અમે જ્યાં સેવા આપીએ છીએ',
      description: 'નિકોલ, નરોડા, બાપુનગર, હંસપુરા, ઓઢવ અને અમદાવાદ-ગાંધીનગરના 100+ વિસ્તારોમાં વ્યાપક સોફા ક્લીનિંગ કવરેજ.',
      badge: 'સેવા કવરેજ',
      title: 'અમદાવાદમાં અમે જ્યાં સેવા આપીએ છીએ',
      subtitle: 'અમે અમદાવાદ અને ગાંધીનગરમાં પ્રોફેશનલ અપહોલ્સ્ટ્રી ક્લીનિંગ સેવાઓ પ્રદાન કરીએ છીએ.',
    ...
    footer: {
      companyName: 'Magical Service',
      companyDescription: 'અમદાવાદ અને ગાંધીનગરમાં પ્રીમિયમ સોફા અને અપહોલ્સ્ટ્રી ક્લીનિંગ સેવાઓ.',
