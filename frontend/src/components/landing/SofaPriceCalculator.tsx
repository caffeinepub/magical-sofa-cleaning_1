...
import { MessageCircle, Calculator, Sofa, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="bg-white rounded-2xl shadow-premium-lg border border-border overflow-hidden">
      ...
      <div className="p-6 space-y-6">
        {/* Service Selection */}
        <div>
          <label className="block text-sm font-semibold text-foreground mb-3 font-body">
            Select Service
          </label>
        ...
        <div>
          ...
          <div className="flex justify-between mt-1">
            <span className="text-xs text-muted-foreground font-body">{MIN_FEET} ft (min)</span>
            <span className="text-xs text-muted-foreground font-body">{MAX_FEET} ft (max)</span>
          </div>
        ...
        <div className="bg-gradient-to-br from-primary/8 to-gold/10 rounded-2xl p-5 border border-primary/15">
          <div className="flex items-center justify-between mb-3">
            <div>
              <p className="text-sm text-muted-foreground font-body">Estimated Price</p>
            ...
            <div className="text-right">
              ...
              <p className="text-xs text-muted-foreground font-body">incl. all charges</p>
            </div>
          </div>
          ...
          <div className="flex justify-between mt-1">
            <span className="text-xs text-muted-foreground font-body">₹{MIN_FEET * PRICE_PER_FOOT}</span>
            <span className="text-xs text-muted-foreground font-body">₹{MAX_FEET * PRICE_PER_FOOT}</span>
          </div>
        </div>
